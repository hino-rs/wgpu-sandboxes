...
impl GuiSystem {
    ...
    pub fn draw_ui(
        ...
        egui::Window::new("Configs").show(&self.egui_ctx, |ui| {
            ...
            ui.separator();
            ui.add(egui::Slider::new(&mut fluid.params.visual_range, 0.01..=0.30).text("Kernel Radius (h)"));
            ui.add(egui::Slider::new(&mut fluid.params.protected_range, 0.0..=2.0).text("Look-Ahead Prediction"));
            ui.add(egui::Slider::new(&mut fluid.params.separation_weight, 0.0001..=10.000).text("Pressure Strength (k)"));
            ui.add(egui::Slider::new(&mut fluid.params.alignment_weight, 0.0001..=10.000).text("Viscosity (Friction)"));
            ui.add(egui::Slider::new(&mut fluid.params.cohesion_weight, 0.0001..=10.000).text("Rest Density Scale"));
            ui.add(egui::Slider::new(&mut fluid.params.max_speed, 0.005..=0.05).text("Max Speed Limit"));
            ui.add(egui::Slider::new(&mut fluid.params.min_speed, 0.0..=0.02).text("Min Speed Limit"));
        });
